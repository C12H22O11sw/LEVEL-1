...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel panel = createHeader("buildings");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed.equals(firstButton)){
			askQuestion("what is the tallest Building in the world?", "Burj Khalifa", 100);
			score += 100;
		}
		else if (buttonPressed.equals(secondButton)){
			askQuestion("Who said 'Less is more'", "Mies Van Der Rohe", 200);
			score += 200;
		}
		else if (buttonPressed.equals(thirdButton)){
			askQuestion("what contrey has the most supertall buildings", "China", 600);
			score += 600;
		}
		else if (buttonPressed.equals(fourthButton)){
			askQuestion("Where is the Burj Khalifa", "Dubai", 1000);
			score += 1000;
		}
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		String bla = JOptionPane.showInputDialog(question);
		// If the answer is correct
		if(bla.equalsIgnoreCase(correctAnswer)){
